...
// Focus on how debugging is done -> the debugging o/p represent the recursion tree's preorder traversal(actually reucsion happens in same way)
// must analyse debugger o/p
int n;
map<int, int> mp;
vector<int> curr;
