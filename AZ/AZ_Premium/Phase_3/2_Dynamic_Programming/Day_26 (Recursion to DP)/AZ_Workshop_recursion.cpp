...
bool check(int lvl) {
    ...
    return (timetaken <= x and itemtaken <= k);
}

int rec(int lvl) {                            // ⭐⭐ returns the max skill that can be gained from [lvl...n - 1] if [0..lvl - 1] is decided
