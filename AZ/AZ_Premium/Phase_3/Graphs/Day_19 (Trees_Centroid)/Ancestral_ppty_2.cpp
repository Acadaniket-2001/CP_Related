...
/*
Problem: Given a tree of N nodes. Find for each node x, min( abs( val[x] - val[y] ) ) for all y
...
o/p:
ans: [ 0 1000000000 3 1 5 0 2 1 1 2 3 10 ]
*/
...
void dfs(int node, int parent) {                                // ⭐ generic code for maintaining the ppty. of ancestors
